...
(struct transaction-io
  (transaction-hash value owner timestamp) #:prefab)

(define (calculate-transaction-hash-io
...
(define (make-transaction-io value owner)
  (let ([timestamp (current-milliseconds)])
    (transaction-io 
     (calculate-transaction-hash-io value owner timestamp)
     value owner timestamp)))

(define (valid-transaction-io? transaction)
  (equal? (transaction-io-transaction-hash transaction)
           (calculate-transaction-hash-io
           (transaction-io-value transaction)
           (transaction-io-owner transaction)
           (transaction-io-timestamp transaction))))
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;                             
(struct transaction
